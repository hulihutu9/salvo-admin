...
use crate::model::gen_table_model::{GenTableList, GenTableColumnList, DbTableList, DbTableColumnList};
...
#[html_sql("src/mapper/xml/gen_xml.html")]
pub async fn get_gen_table_by_name(rb: &mut dyn Executor,table_name:String
) ->rbatis::Result<Vec<GenTableList>> {
    impled!()
}
...
#[html_sql("src/mapper/xml/gen_xml.html")]
pub async fn get_db_table_columns_by_name(
    rb: &mut dyn Executor, table_name: String
) ->rbatis::Result<Vec<DbTableColumnList>> {
    impled!()
}
